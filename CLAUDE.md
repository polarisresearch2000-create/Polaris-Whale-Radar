...
> 当前版本 **V10.5**。详细迭代见 [CHANGELOG.md](CHANGELOG.md)。
...
| ~~🏁 置顶③今日赛果~~ **已退休(V7.1)** | 领头是纯命中率(命中≠盈利,理念冲突)+与①②重复;`postOrUpdateResultsPin` 现只一次性取消旧置顶。赛果 ROI 仍在①看 | — | — |
| 📒 置顶📒我的下注台账（你真实下的注·已实现盈亏/ROI/胜率·就地刷新，ledgerPinId存digest） | 随赢家出手digest | ❌ | ✅ |
